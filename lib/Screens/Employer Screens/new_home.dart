  ...
  Future<void> setData(String category) async {
    ...
    try{
      ...
      await FirebaseFirestore.instance
        ...
        .doc(category)
        .set(
        {'city': _city,'state': _state, 'religion': ["Hindu","Muslim","Christian","Others"],'duration': ["Less than 2","2-4","4-6","More than 6"], 'gender': ["Male","Female","Others"], 'budget': "Low to High", 'yearofexp': "High to Low"});
    }
    catch(e){
      print("Error: " + e);
    }
