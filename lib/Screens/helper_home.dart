                  ...
                  children: <Widget>[
                    Align(
                      ...
                      child:CircleAvatar(
                          ...
                          backgroundImage: AssetImage('assets/images/maid.jpg'),
                        ),
                    ),
                    Align(
                      ...
                      child: GestureDetector(
                        child: Container(
                          margin: EdgeInsets.fromLTRB(40, 100, 110, 0),
  ...
  Future<void> setValue() async {
    try{
      ...
      await FirebaseFirestore.instance
        ...
        .doc(user)
        .set(
        {'name': _name,'contact no': _contactno, 'address': _address,'age': _age, 'category': _category, 'city': _city, 'duration': _duration, 
         'email': user, 'exp salary': _expectedsalary, 'gender': _gender, 'language': _languages, 'marital status': _maritalstatus, 'photo': "https://static3.bigstockphoto.com/6/9/7/large1500/7963525.jpg", 
